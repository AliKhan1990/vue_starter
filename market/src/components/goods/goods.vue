  ...
  <el-row>
    <el-col :span="5" class="menu-wrap">
      <div class="grid-content">
        <scroller lock-x height="-180" ref="menuScroller" @on-scroll="flScroll">
          <ul class="kinds-list">
    ...
    <el-col :span="19" class="foods-wrap">
      <div class="grid-content">
        <scroller class="goods-wrap" height="-180" lock-x @on-scroll="fsScroll" ref="foodsScroller">
          <ul class="goods-list">
...
<script type="text/ecmascript-6">
  ...
  export default{
    ...
    methods:{
      ...
      listClick(index){
        this.$refs.foodsScroller.reset({top:this.listHeight[index]+4},300)
      }
    },
    computed:{
        currentIdx(){
